...
var SignalingAndMetricsConnectionMonitor = /** @class */ (function () {
    ...
    SignalingAndMetricsConnectionMonitor.prototype.didReceivePong = function (latencyMs, clockSkewMs) {
    ...
    SignalingAndMetricsConnectionMonitor.prototype.metricsDidReceive = function (clientMetricReport) {
        ...
        var availableSendBandwidth = metricReport.availableSendBandwidth;
        var availableRecvBandwidth = metricReport.availableReceiveBandwidth;
