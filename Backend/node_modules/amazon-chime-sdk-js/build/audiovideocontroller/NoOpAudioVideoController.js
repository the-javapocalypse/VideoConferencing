...
var NoOpAudioVideoController = /** @class */ (function (_super) {
    ...
    function NoOpAudioVideoController(configuration) {
        ...
        _this = _super.call(this, configuration ? configuration : emptyConfiguration, new NoOpDebugLogger_1.default(), new DefaultWebSocketAdapter_1.default(new NoOpDebugLogger_1.default()), new NoOpDeviceController_1.default(), new DefaultReconnectController_1.default(0, new FullJitterBackoff_1.default(0, 0, 0))) || this;
        return _this;
    }
