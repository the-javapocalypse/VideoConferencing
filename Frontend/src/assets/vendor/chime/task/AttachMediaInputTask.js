    ...
    AttachMediaInputTask.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (audioInput) {
                    audioTracks = audioInput.getTracks();
                    if (this.context.browserBehavior.requiresUnifiedPlan()) {
                        ...
                        audioInput.getTracks().forEach(function (track) {
                            if (!senders_1.find(function (sender) {
                                ...
                                // @ts-ignore
                                _this.context.peer.addTrack(track, audioInput);
                            }
                        });
                    }
                }
                ...
                if (videoInput) {
                    videoTracks_1 = videoInput.getTracks();
