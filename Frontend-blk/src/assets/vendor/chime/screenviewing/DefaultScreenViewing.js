...
var DefaultScreenViewing = /** @class */ (function () {
    ...
    DefaultScreenViewing.prototype.open = function (request) {
        ...
        return this.componentContext.jpegDecoderController
            ...
            .then(function () { return _this.componentContext.viewingSession.openConnection(request); })
            .then(function () { });
    };
    DefaultScreenViewing.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.componentContext.signalingSession.close()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.componentContext.viewingSession.closeConnection()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
