...
export default interface AudioVideoFacade extends AudioVideoControllerFacade, VideoTileControllerFacade, AudioMixControllerFacade, RealtimeControllerFacade, ActiveSpeakerDetectorFacade, DeviceController {
}
